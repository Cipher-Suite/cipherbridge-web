    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: T.bg }}>
      ...
      <style>{`
        @media (max-width: 767px) {
          .app-main { margin-left: 0 !important; padding: 80px 16px 32px !important; }
        }
      `}</style>
    </div>
  );
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      {/* Dashboard — was "/" now "/dashboard" */}
      <Route path="/dashboard"     element={<AuthGuard><AppLayout><Overview /></AppLayout></AuthGuard>} />
